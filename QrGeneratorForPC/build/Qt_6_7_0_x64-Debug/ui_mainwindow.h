...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(180, 250, 171, 31));
        QFont font;
        font.setPointSize(14);
        label->setFont(font);
        generation = new QPushButton(centralwidget);
        generation->setObjectName("generation");
        generation->setGeometry(QRect(280, 360, 211, 51));
        ...
        comboBox->setGeometry(QRect(390, 250, 231, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        comboBox->setItemText(0, QCoreApplication::translate("MainWindow", "Huawei", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("MainWindow", "Honor", nullptr));
        comboBox->setItemText(2, QCoreApplication::translate("MainWindow", "Apple", nullptr));
        comboBox->setItemText(3, QCoreApplication::translate("MainWindow", "Asus", nullptr));
